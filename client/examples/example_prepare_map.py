...
"""
Digital Twin Client - PrepareMap Example
...
try:
    import dt_client
    from dt_client import OSMTask, GMLTask
...
def main(args: argparse.Namespace):
    ...
    print(f"\nPreparing {args.task.upper()} map -> s3://{args.s3_bucket}/{args.output_folder_key}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PrepareMap Example")
    parser.add_argument("--server_address", type=str, default="localhost:50051")
    parser.add_argument("--task", type=str, default="osm", choices=["osm", "gml"])
    parser.add_argument("--output_folder_key", type=str, default="demo_gis/test_osm.usd")
    ...
    parser.add_argument("--epsg_in", type=str, default="6697")
